...
var CheckBoxField = function CheckBoxField(_ref) {
  ...
  return _react.default.createElement(_semanticUiReact.Form.Field, _extends({
    ...
    required: required,
    width: width
  }, custom), _react.default.createElement(_semanticUiReact.Checkbox, {
    label: label,
    checked: !!input.value,
    onClick: function onClick(event, data) {
      return input.onChange(data.checked);
    }
  }), touched && error ? _react.default.createElement(_semanticUiReact.Label, {
    basic: true,
    color: "red",
    pointing: true
  }, error) : null);
...
CheckBoxField.propTypes = _objectSpread({}, _FieldPropTypes.fieldProps);
