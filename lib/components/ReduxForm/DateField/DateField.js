...
var DateField = function DateField(_ref) {
  var input = _ref.input,
      ...
      rest = _objectWithoutProperties(_ref, ['input', 'label', 'onChange', 'initialValue', 'required', 'width', 'inline', 'meta']);
...
DateField.propTypes = _extends({}, _FieldPropTypes.fieldProps);
