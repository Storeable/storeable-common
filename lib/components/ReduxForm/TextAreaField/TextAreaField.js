...
var TextAreaField = function TextAreaField(_ref) {
  ...
  return _react.default.createElement(_semanticUiReact.Form.Field, {
    ...
    width: width,
    inline: inline
  }, label && _react.default.createElement("label", null, label), _react.default.createElement(_semanticUiReact.TextArea, _extends({}, input, rest)), touched && error ? _react.default.createElement(_semanticUiReact.Label, {
    basic: true,
    color: "red",
    pointing: true
  }, error) : null);
