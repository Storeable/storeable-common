  ...
  _createClass(CheckBoxGroupField, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_semanticUiReact.Form.Group, {
        grouped: grouped
      }, label && _react.default.createElement(_semanticUiReact.Form.Field, {
        error: !!(touched && error),
        required: required
      }, _react.default.createElement("label", null, label)), options.map(function (option, i) {
      ...
      }), touched && error && _react.default.createElement(_semanticUiReact.Form.Field, {
        error: true
