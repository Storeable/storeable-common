...
var getListingFee = exports.getListingFee = function getListingFee(total) {
  ...
  var normalizedFee = void 0;
  if (typeof fee === 'undefined') {
    normalizedFee = _fees.fees[_fees.LISTING_FEE].price;
  }

  if (!(0, _number.isNumber)(normalizedFee)) {
    return 0;
  }
...
var getTotalCost = exports.getTotalCost = function getTotalCost(sqFt, sqFtCost, spaceTypeSqFtCost) {
  ...
  if (includeFees) {
    var listingFee = (typeof includeFees === 'undefined' ? 'undefined' : _typeof(includeFees)) === 'object' ? includeFees.listingFee : undefined;
    var insuranceFee = (typeof includeFees === 'undefined' ? 'undefined' : _typeof(includeFees)) === 'object' ? includeFees.insuranceFee : undefined;
 ...
 * @returns {Object}
 */
var getPricesBySpaceFeature = exports.getPricesBySpaceFeature = function getPricesBySpaceFeature(spaceFeatures) {
 ...
 * @returns {Object}
 */
var calculateTotal = exports.calculateTotal = function calculateTotal(basePrice, length, width) {
  return Number(basePrice) + Number(length) + Number(width);
};